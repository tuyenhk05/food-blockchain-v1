  ...
  return <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-16 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link to="/" className="inline-flex items-center text-sm text-gray-500 hover:text-emerald-600 mb-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-bold ${batch.currentStatus === 'Delivered' ? 'bg-emerald-100 text-emerald-800' : batch.currentStatus === 'In Transit' ? 'bg-blue-100 text-blue-800' : 'bg-orange-100 text-orange-800'}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <ProductInfoCard conditions={batch.conditions} expiryDate={batch.expiryDate} harvestDate={batch.harvestDate} />
