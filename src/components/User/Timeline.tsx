...
export function Timeline({ stages }: TimelineProps) {
  return (
    <div className="relative pl-4 sm:pl-8 py-8">
      {/* Vertical Line */}
        ...
        {stages.map((stage, index) => {
          ...
          return (
            ...
            >
              {/* Icon Circle */}
              <div
                className={`relative z-10 flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full border-4 ${
                  isCompleted
                    ? "bg-emerald-600 border-emerald-100 text-white"
                    : isCurrent
                    ? "bg-blue-600 border-blue-100 text-white animate-pulse"
              ...
              {/* Content Card */}
              <div
                className={`flex-1 bg-white rounded-xl p-6 shadow-sm border ${
                  isCurrent
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
                  ...
                  {stage.blockchain.verified && (
                    <BlockchainBadge
                      txHash={stage.blockchain.txHash}
